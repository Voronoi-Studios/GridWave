...
tasks.named<ProcessResources>("processResources") {
    var replaceProperties = mapOf(
        ...
        "plugin_examples_description" to findProperty("plugin_examples_description"),
        "plugin_website" to findProperty("plugin_website"),

        "plugin_examples_main_entrypoint" to findProperty("plugin_examples_main_entrypoint"),
