...
public abstract class TileSet {
    ...
    protected static Vector3i rotate(Vector3ic v, int r) {
        int x = v.x();
        int z = v.z();
    ...
    public static TileEntry offsetTileEntry(TileEntry entry, Vector3ic offset) {
        Map<Vector3ic, RuleCombo> newRuleSets = new LinkedHashMap<>();
        for (Map.Entry<Vector3ic, RuleCombo> e : entry.ruleSets().entrySet()) {
