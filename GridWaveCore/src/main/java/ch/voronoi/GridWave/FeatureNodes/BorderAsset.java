...
public class BorderAsset extends FeatureAsset {
    ...
    private RuleSetAsset borderRuleSet = new SimpleRuleSet2DAsset();
    ...
    public void BaseWaveProcessor(@NonNull List<Vector3d> gridPositions, Map<Vector3i, WaveCell> baseWave, TileSetAsset.Argument argument) {
        ...
        TileSet.TileEntry borderTile = new SingleTileSet(new ConcurrentHashMap<>(), borderRuleSet.build(),1,false, argument, new ArrayList<>()).getTileEntries().getFirst();
