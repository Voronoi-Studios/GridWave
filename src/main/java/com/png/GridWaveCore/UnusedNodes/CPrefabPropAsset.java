package com.png.GridWaveCore.UnusedNodes;
...
public class CPrefabPropAsset extends PropAsset {
    @Nonnull
    public static final BuilderCodec<CPrefabPropAsset> CODEC = BuilderCodec.builder(CPrefabPropAsset.class, CPrefabPropAsset::new, PropAsset.ABSTRACT_CODEC)
            .append(
                    new KeyedCodec<>("WeightedPrefabPaths", new ArrayCodec<>(CPrefabPropAsset.CWeightedPathAsset.CODEC, CPrefabPropAsset.CWeightedPathAsset[]::new), true),
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        if (!super.skip() && this.weightedPrefabPathAssets.length != 0) {
            ...
            if (prefabWeightedMap.size() == 0) {
            ...
            } else if (this.scannerAsset != null && this.directionalityAsset != null) { //Depreciated
                ...
                return new CPrefabProp(prefabWeightedMap, argument.materialCache, argument.parentSeed);
            }
        } else {
            return EmptyProp.INSTANCE;
        }
    ...
    public static class CWeightedPathAsset implements JsonAssetWithMap<String, DefaultAssetMap<String, CPrefabPropAsset.CWeightedPathAsset>> {
        @Nonnull
        public static final AssetBuilderCodec<String, CPrefabPropAsset.CWeightedPathAsset> CODEC = AssetBuilderCodec.builder(
                        CPrefabPropAsset.CWeightedPathAsset.class,
                        CPrefabPropAsset.CWeightedPathAsset::new,
                        Codec.STRING,
