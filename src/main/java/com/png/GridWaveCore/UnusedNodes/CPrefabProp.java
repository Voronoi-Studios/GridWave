...
public class CPrefabProp extends Prop {
    @Nonnull
    ...
    @Nonnull
    private final CPrefabProp.IntersectingColumnPredicate<PrefabBufferCall> rColumnPredicate;
    @Nonnull
    private final Vector3i rWorldPosition;
    @Nonnull
    private final Vector3d rEntityWorldPosition;

    public CPrefabProp(@Nonnull WeightedMap<List<IPrefabBuffer>> prefabPool, @Nonnull MaterialCache materialCache, @Nonnull SeedBox seedBox) {
        ...
        this.rColumnPredicate = new CPrefabProp.IntersectingColumnPredicate<>();
